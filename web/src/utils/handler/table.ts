...
const table: { [key: string]: Handler<never>[] } = {
	...
	'sign.in': [
		okResponse('Vous êtes de retour !', "Qu'allez-vous lire ou écrire aujourd'hui ?"),
		badRequestError(),
		notFoundError('Informations invalides.'),
	],
	...
	'articles.search.many': [okResponse('Articles trouvés.'), notAuthError()],
