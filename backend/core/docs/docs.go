...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/core_router_articles.Article"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/core_router_bookmarks.Article"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "core_router_articles.Article": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
                },
                "hasConnectedUserLiked": {
                    "type": "boolean"
                },
                "id": {
                    "type": "integer"
